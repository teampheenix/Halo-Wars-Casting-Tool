...
terrifying <emphasis level="moderate">{race}</emphasis></speak>"""
        option['ssml_2'] = """<emphasis level="moderate"><speak>Spawning in the
{color} corner</emphasis> we have the
amazing <emphasis level="moderate">{player}</emphasis> playing as the
fabled <emphasis level="moderate">{race}</emphasis></speak>"""
